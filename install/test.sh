...
test "Test filter" "$ASTERIX -d config/asterix.ini -L test_output/filter.txt" "test_output/filter.txt"
...
test "Test json CAT_001_002" "$ASTERIX -d config/asterix.ini -R -j -f sample_data/cat_001_002.pcap -LF test_output/filter.txt" "test_output/cat_001_002_json.txt"
test "Test jsonh CAT_001_002" "$ASTERIX -d config/asterix.ini -R -jh -f sample_data/cat_001_002.pcap -LF test_output/filter.txt" "test_output/cat_001_002_jsonh.txt"
